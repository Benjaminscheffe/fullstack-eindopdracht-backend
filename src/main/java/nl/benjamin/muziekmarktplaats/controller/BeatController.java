...
public class BeatController {
    ...
    public BeatController(BeatService service, ImageService imageService, BeatMapper mapper) {
    ...
    @GetMapping("/{id}/image")
    public ResponseEntity<Resource> getStudentPhoto(@PathVariable("id") Long beatId, HttpServletRequest request){
